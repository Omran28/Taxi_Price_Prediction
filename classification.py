...
taxiData = pd.read_csv('taxi-rides-classification.csv')
...
# Predict rain values
x_train, x_test, y_train, y_test = train_test_split(X1, Yrain, test_size=0.20, shuffle=True, random_state=10)
...
# p = poly_model.predict(poly_features.fit_transform(X_test))
...
joblib.dump(one_hot_data, 'encoder.joblib')
...
poly_features = PolynomialFeatures(degree=2)
X = known_category.iloc[:, Values.columns != 'RideCategory']
Y = known_category["RideCategory"]
X = poly_features.fit_transform(X)

X_train, X_test, Y_train, Y_test = train_test_split(X, Y, test_size=0.20, shuffle=True)
classifier = DecisionTreeClassifier(max_depth=14, min_samples_leaf=7)
classifier.fit(X_train, Y_train)
pickle.dump(classifier, open("unknown_prediciton.pkl", "wb"))
y_pred = classifier.predict(X_test)
print("DTC testing accuracy: ", accuracy_score(y_pred, Y_test))
...
# Select From Model (L1-based feature selection)
lsvc = LinearSVC(C=0.001, penalty="l1", dual=False).fit(X_poly, Y)
model = SelectFromModel(lsvc, prefit=True)
pickle.dump(classifier, open("classification_selection.pkl", "wb"))
...
# Poly SVC
t = time.time()
svc = svm.SVC(kernel='poly', degree=3, C=0.9)
svc.fit(X_train, Y_train)
pickle.dump(svc, open("SVC Poly_3_0.9.pkl", "wb"))
...
# DTC
t = time.time()
classifier = DecisionTreeClassifier(max_depth=7, min_samples_leaf=7)
classifier.fit(X_train, Y_train)
pickle.dump(classifier, open("DTC_7_7.pkl", "wb"))
Time_Training.append(time.time() - t)
...
# KNN
t = time.time()
classifier = KNeighborsClassifier(n_neighbors=40, p=5)
classifier.fit(X_train, Y_train)
pickle.dump(classifier, open("KNN_40_5.pkl", "wb"))
Time_Training.append(time.time() - t)
...
classifier.fit(X_train, Y_train)
pickle.dump(classifier, open("IDA_2_0.pkl", "wb"))
Time_Training.append(time.time() - t)
...
# classifier.fit(X_train, Y_train)
# pickle.dump(classifier, open("DTC_5_10.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# y_pred = classifier.predict(X_test)
...
# classifier.fit(X_train, Y_train)
# pickle.dump(classifier, open("DTC_5_6.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# y_pred = classifier.predict(X_test)
...
# # 3 DTC
# t = time.time()
# classifier = DecisionTreeClassifier(max_depth=5, min_samples_leaf=2)
# classifier.fit(X_train, Y_train)
# pickle.dump(classifier, open("DTC_5_2.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# y_pred = classifier.predict(X_test)
...
# classifier = DecisionTreeClassifier(max_depth=14, min_samples_leaf=7)
# classifier.fit(X_train, Y_train)
# pickle.dump(classifier, open("DTC_14_7.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# y_pred = classifier.predict(X_test)
...
# # 6 DTC
# t = time.time()
# classifier = DecisionTreeClassifier(max_depth=1, min_samples_leaf=7)
# classifier.fit(X_train, Y_train)
# pickle.dump(classifier, open("DTC_1_7.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# y_pred = classifier.predict(X_test)
...
# # 1 Poly SVC
# t = time.time()
# svc = svm.SVC(kernel='poly', degree=1, C=0.5)
# svc.fit(X_train, Y_train)
# pickle.dump(svc, open("SVC Poly_1_0.5.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# testingPrediction = svc.predict(X_test)
...
# # 2 Poly SVC
# t = time.time()
# svc = svm.SVC(kernel='poly', degree=10, C=0.5)
# svc.fit(X_train, Y_train)
# pickle.dump(svc, open("SVC Poly_10_0.5.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# testingPrediction = svc.predict(X_test)
...
# # 3 Poly SVC
# t = time.time()
# svc = svm.SVC(kernel='poly', degree=20, C=0.5)
# svc.fit(X_train, Y_train)
# pickle.dump(svc, open("SVC Poly_20_0.5.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# testingPrediction = svc.predict(X_test)
...
# # 4 Poly SVC
# t = time.time()
# svc = svm.SVC(kernel='poly', degree=3, C=0.1)
# svc.fit(X_train, Y_train)
# pickle.dump(svc, open("SVC Poly_3_0.1.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# testingPrediction = svc.predict(X_test)
...
# # 5 Poly SVC
# t = time.time()
# svc = svm.SVC(kernel='poly', degree=3, C=0.6)
# svc.fit(X_train, Y_train)
# pickle.dump(svc, open("SVC Poly_3_0.6.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# testingPrediction = svc.predict(X_test)
...
# # 1(KNN)
# t = time.time()
# classifier = KNeighborsClassifier(n_neighbors=29, p=1)
# classifier.fit(X_train, Y_train)
# pickle.dump(classifier, open("KNN_29_1.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# y_pred = classifier.predict(X_test)
...
# # 2 (KNN)
# t = time.time()
# classifier = KNeighborsClassifier(n_neighbors=29, p=5)
# classifier.fit(X_train, Y_train)
# pickle.dump(classifier, open("KNN_29_5.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# y_pred = classifier.predict(X_test)
...
# # 3 (KNN)
# t = time.time()
# classifier = KNeighborsClassifier(n_neighbors=29, p=12)
# classifier.fit(X_train, Y_train)
# pickle.dump(classifier, open("KNN_29_12.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# y_pred = classifier.predict(X_test)
...
# classifier.fit(X_train, Y_train)
# pickle.dump(classifier, open("KNN_5_5.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# y_pred = classifier.predict(X_test)
...
# # 5(KNN)
# t = time.time()
# classifier = KNeighborsClassifier(n_neighbors=20, p=5)
# classifier.fit(X_train, Y_train)
# pickle.dump(classifier, open("KNN_20_5.pkl", "wb"))
# Time_Training.append(time.time() - t)
#
# t = time.time()
# y_pred = classifier.predict(X_test)
